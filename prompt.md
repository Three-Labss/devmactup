...
Setup proyecto y dependencias básicas
Sistema de mock-data en memoria
Mock AI extraction
API de upload (simulado)
Componentes de onboarding (upload, preguntas, preview)
API y UI de swipe
Sistema de matches
Landing page y navegación
Polish final (animaciones, errores, responsive)
